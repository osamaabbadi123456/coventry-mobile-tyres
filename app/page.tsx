...
const emailAddress = "info@coventrymobiletyres.co.uk";

const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi%2C%20I%20need%20mobile%20tyre%20assistance%20in%20Coventry.`;
...
const services = [
  {
    ...
    text: "Fast mobile tyre replacement at your home, workplace or roadside location in Coventry.",
  },
  {
    icon: <Wrench />,
...
const faqs = [
  {
    q: "Do you offer 24/7 mobile tyre fitting in Coventry?",
    a: "Yes, Coventry Mobile Tyres provides emergency mobile tyre help across Coventry including roadside, home and workplace call-outs.",
  },
  {
  ...
  },
  {
    ...
    a: "Send your tyre size, vehicle model and Coventry location for a fast response.",
  },
  {
  ...
  },
  {
    ...
    a: "We cover Coventry City Centre, Kenilworth, Earlsdon, Bedworth, Canley, Binley, Tile Hill, Nuneaton and nearby areas.",
  },
];
    ...
    <main className="bg-white text-slate-950 overflow-x-hidden">
      ...
      <section className="bg-[#FFFFFF] text-black">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-3">
          <a
            href={`tel:${phoneNumber}`}
            className="block w-full rounded-2xl bg-[#1F6FA9] px-4 py-3 text-center shadow-xl shadow-blue-700/30 animate-pulse"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-3">
          <a
            href={`tel:${phoneNumber}`}
            className="block w-full rounded-full bg-[#1F6FA9] px-5 py-3 shadow-xl shadow-blue-700/30 text-center animate-pulse"
            style={{ animationDuration: "0.7s" }}
          >
            <span className="text-white text-sm sm:text-lg font-black uppercase tracking-wide">
      ...
      {/* HERO CONTENT */}
      <section className="relative bg-[#1F6FA9] text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 pt-14 sm:pt-20 pb-20">
          ...
          >
            ...
            <p className="mt-6 text-base sm:text-lg md:text-xl text-gray-100 leading-relaxed max-w-2xl">
              Emergency mobile tyre fitting in Coventry. Fast roadside tyre
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 text-white">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold">Coventry & nearby areas</span>
              </div>
      ...
      <section className="relative bg-white py-12 sm:py-16 overflow-hidden">
        <div className="max-w-[1800px] mx-auto px-3 sm:px-6">
          <div className="mb-8 max-w-7xl mx-auto rounded-2xl bg-[#1F6FA9] text-white p-6 sm:p-8 shadow-2xl border border-slate-800">
            ...
            <h2 className="text-3xl sm:text-5xl font-black uppercase leading-tight">
              ...
              <span className="block text-red-500">across Coventry</span>
            </h2>
            ...
            <p className="text-gray-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
              ...
              Coventry location on WhatsApp for a fast response.
            </p>
          </div>
      ...
      {/* MOVING BAR */}
      <section className="bg-[#1F6FA9] text-white overflow-hidden whitespace-nowrap">
        <motion.div
          animate={{ x: ["0%", "-50%"] }}
      ...
      <section className="py-20 px-5 sm:px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black uppercase leading-tight mb-12">
            Every Tyre Service,
            <span className="block text-[#1F6FA9]">At Your Location</span>
          </h2>
      ...
      {/* HOW IT WORKS */}
      <section className="py-20 px-5 sm:px-6 bg-[#1F6FA9] text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              ["02", "Send Location", "Share your Coventry location with us."],
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase leading-tight mb-6">
              Mobile Tyre Fitting
              <span className="block text-[#1F6FA9]">Across Coventry</span>
            </h2>
            <p className="text-gray-600 leading-relaxed text-lg">
              Coventry Mobile Tyres provides emergency mobile tyre fitting,
              puncture repair and roadside tyre replacement across Coventry and
              nearby areas.
            </p>
          </div>
      ...
      <section className="py-20 px-5 sm:px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black uppercase leading-tight mb-10">
            Got Questions?
            <span className="block text-[#1F6FA9]">We Can Help</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-slate-700 leading-relaxed mb-8">
              ...
              options, helping Coventry drivers get back on the road quickly and
              safely.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
            {[
              ...
              "Out of hours tyre fitting Coventry",
              "Home mobile tyre fitting",
              "Workplace tyre fitting",
              "Van mobile tyre fitting Coventry",
            ].map((item) => (
              <div
                key={item}
          ...
          <div className="grid lg:grid-cols-2 gap-12 mt-16 items-start">
            <div>
              <h3 className="text-3xl font-black uppercase text-slate-950 mb-5">
                Trusted Mobile Tyre Fitters In Coventry
              </h3>

              <p className="text-slate-700 leading-relaxed mb-5">
                We aim to be one of Coventry’s reliable mobile tyre fitting
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                is built around urgent tyre call-outs across Coventry. If your
            ...
            <div className="bg-[#1F6FA9] text-white rounded-[2rem] p-8 shadow-2xl">
            ...
            {[
              {
                ...
                text: "Rapid mobile tyre fitting throughout Coventry and surrounding areas.",
              },
              {
          ...
          <div className="mt-16 bg-slate-950 text-white rounded-[2rem] p-8 sm:p-10">
            <h3 className="text-3xl sm:text-4xl font-black uppercase mb-5">
              Book Mobile Tyre Fitting Coventry Today
            </h3>

            <p className="text-gray-300 leading-relaxed text-lg mb-6">
              If you need emergency tyre fitting, same day tyres, mobile
              puncture repair, roadside tyre replacement, cheap tyres Coventry,
              24 hour tyre fitting, home tyre fitting or workplace tyre fitting,
              Coventry Mobile Tyres is ready to help.
            </p>
      ...
      <section className="py-16 px-5 sm:px-6 bg-red-600 text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-black uppercase mb-5">
            Need Emergency Mobile Tyres In Coventry?
          </h2>
      ...
      {/* FOOTER */}
      <footer className="bg-[#1F6FA9] text-white px-5 sm:px-6 py-10 pb-24 md:pb-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 items-center">
          <Logo />

          <div className="text-gray-300 text-sm leading-relaxed">
            <p className="font-black text-white mb-1">Coventry Mobile Tyres</p>
            <p>24/7 emergency mobile tyre fitting across Coventry.</p>
      ...
      {showBackToTop && (
        <button
          ...
          className="fixed bottom-24 right-5 z-[60] w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#1F6FA9] text-white shadow-2xl flex items-center justify-center hover:bg-red-600 hover:-translate-y-1 transition-all duration-300"
